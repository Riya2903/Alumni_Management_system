...
#include "alumni_files.cpp"
#include "student_files.cpp"
...
lock_guard<mutex> lock(mylock);
	...
	string var;
	string passcode = "UADMIN003";
	string passcode1 = "UADMIN002";
	string passcode2 = "UADMIN001";
	cout<<endl<<"Enter the passcode in order to access admin dashboard"<<endl;
cin>>var;
 if(var==passcode || var==passcode1 || var==passcode2)
 {
    int choice6=0;
    while(choice6!=7){
