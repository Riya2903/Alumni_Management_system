...
{
	CPPUNIT_ASSERT(true==myobj3->Email_check("rehanappm@gmail.com"));
}


void test:: test_check_alumni_register_number(void)
{
        CPPUNIT_ASSERT(1==myobj3->check_alumni_register_number("UA1000"));
}

void test:: test_alumni_get_data(void)
{
        CPPUNIT_ASSERT(0==myobj1->alumni_get_data());
}


void test::test_Edit_Info(void)
{
	CPPUNIT_ASSERT(0==myobj2->Edit_Info("US1000"));
}
